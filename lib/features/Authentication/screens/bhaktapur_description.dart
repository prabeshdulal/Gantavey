  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
            ...
            height: 741,
             child: SingleChildScrollView(
              ...
              child: Column(
                  ...
                  children: [
                  const Gap(10),
        const Text("A little about Bhaktapur", style: TextStyle(
          fontSize: 32,
        )),
        Container(
        ...
        Container(
            padding: const EdgeInsets.only(left: 10),
            child: const Text("Celebrate Jatras Evening walk in the Bhaktapur Durbar square \nPottery work \nReligious Journey \nEnjoy the specialty of Bhaktapur: Ju Ju dhau \nShopping at Bhaktapur"))
              ]),
            ),
          ),
          Container(
